 ...
 */
  ...
  // BT: the png_struct_def is no longer exposed in png.h, but in pngstruct.h,
  //     however this seems to no longer be automatically included so that's why
  //     we do it here manually. probably a better way exists but currently this
  //     way works fine
  #include "pngpriv.h"
